...
<div class="container cnt"><div class="col-md-12">
    ...
    <div class="media news">
        <div class="media-left">
                <a href="<?=Url::to(['blog/show','translit'=>$item->translit,'id'=>$item->id])?>"><img src="<?=Yii::$app->request->baseUrl.'/upload/news/ico/'.$item->image?>" alt="<?=Html::encode($item->title)?>" width="250" height="180" border="0" class="media-object img-responsive img-thumbnail" /></a>
        </div>
        <div class="media-body content-news">
            <p class="date"><?=Yii::$app->formatter->asDatetime($item->date, 'd/M/Y')?></p>
                <a href="<?=Url::to(['blog/show','translit'=>$item->translit,'id'=>$item->id])?>" class="name"><?=$item->title?></a>
